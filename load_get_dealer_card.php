...
if(isset($_SESSION['cards'])){
	...
	$size=sizeof($cards);
		...
		if($size==47 OR $size==46){
			...
			$dealer_card_c="$rand_card";
			$_SESSION['dealer_card_c']="$rand_card";
		}
		if($size==45 OR $size==44){
			// Buscar A segunda Carta
			$dealer_card_d="$rand_card";
			$_SESSION['dealer_card_d']="$rand_card";
		}
