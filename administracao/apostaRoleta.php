...
<head>
   ...
   <?php
	...
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
	 ...
	 <title>SafeBet Admin - Apostas Roleta</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tabela De Apostas</h4>
                                <p class="category">Roleta</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                ...
                                $query = "SELECT * FROM apostaroleta";  
                                ...
                                echo          
                                    ...
                                    <thead>
                                        <th>idAposta</th>
                                        <th>DinheiroApostado</th>
                                        <th>CorApostada</th>
                                        <th>Final(Ganhou=G, Perdeu=P)</th>
                                        <th>idUtilizador</th>
                                    ...
                                    foreach($data as $row){
                                        ...
                                        <tr>
                                            <td>'. $row['idAposta'].'</td>
                                            <td>'. $row['dinheiroApostado'].'</td>
                                            <td>'. $row['corApostada'].'</td>
                                            <td>'.$row['final'].'</td>
